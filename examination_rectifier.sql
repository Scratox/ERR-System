...
(1, 101, 'Solving Equations', '2024-02-14 08:30:00', 'Pending', 1),
(2, 102, 'Calculus Problems', '2024-03-04 09:45:00', 'Under Review', 2),
(3, 103, 'Physics Experiment Report', '2024-04-19 14:00:00', 'Accepted', 3);
...
INSERT INTO `teachers` (`TeacherID`, `FirstName`, `LastName`, `Email`, `DepartmentID`) VALUES
(201, 'Professor', 'Smith', 'prof.smith@example.com', 1),
(202, 'Dr.', 'Johnson', 'dr.johnson@example.com', 2),
(203, 'Mrs.', 'Brown', 'mrs.brown@example.com', 3);
